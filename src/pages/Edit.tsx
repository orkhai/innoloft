...
const Edit = () => {
  ...
  const editProduct = async () => {
    try {
      await axios.put("https://api-test.innoloft.com/product/6781/", {
        description,
      });
    } catch (error) {
      console.log(error);
        ...
        <div className="bg-[#F5F4F9] font-sans min-h-screen">
          ...
          <div className="w-[90%] mx-auto py-5">
            <div className="bg-white mt-6 rounded-[6px] lg:flex lg:justify-between">
              <div className="lg:w-[55%]">
                ...
                <div className="p-[11px]">
                  ...
                  <textarea
                    className="text-[14px] mt-3 leading-[24px] text-[#6B7280] w-full border rounded-md border-main p-2"
                    rows={8}
            ...
            <div className="mt-[20px] py-[20px] px-[10px] lg:px-[40px] bg-white rounded-[6px]">
              ...
              <button
                onClick={editProduct}
                className="bg-main text-white py-[5px] px-[10px] rounded-[6px] text-[14px] mt-6"
              >
                Save
              </button>
            </div>
